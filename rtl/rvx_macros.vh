`ifndef __RVX__MACROS__VH__
`define __RVX__MACROS__VH__
...
// States in M-mode
`define RVX_MMODE_STATE_RESET 4'b0001
`define RVX_MMODE_STATE_OPERATING 4'b0010
`define RVX_MMODE_STATE_TRAP_TAKEN 4'b0100
`define RVX_MMODE_STATE_TRAP_RETURN 4'b1000
